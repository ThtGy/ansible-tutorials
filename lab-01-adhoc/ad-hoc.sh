...
ansible node01 -b -m git -a "repo=https://github.com/becloudready/prometheus_monitoring.git dest=/tmp1 version=HEAD"
...
ansible -m copy -a "src=README.md dest=/tmp1" node01 --become
